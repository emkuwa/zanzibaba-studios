          ...
          {KEYS.map((k, i) => {
            ...
            return (
              <Reveal key={k} delay={i * 60} className="group">
                <div className="card-tilt relative h-full overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.06] via-white/[0.02] to-transparent transition-colors hover:border-coral-400/40">
                  <div
                  ...
                  <div className="relative h-36 w-full overflow-hidden sm:h-40">
                    ...
                    <div className="absolute right-4 top-4 text-[10px] uppercase tracking-[0.32em] text-lagoon-300/80">
                  ...
                  <div className="relative flex flex-col p-6">
                    ...
                    <div className="mt-4 flex items-center justify-between text-[10px] uppercase tracking-[0.32em] text-white/35">
                      ...
                      <ArrowUpRight
                        className="h-4 w-4 text-white/40 transition-all group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:text-coral-300"
                        aria-hidden="true"
                      />
                    </div>
                  </div>
